...
class Resampler:
    """
    Resamples the daily dataset to a target frequency (D, W, M).
    ...
    def resample(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        Args:
            df: Daily DataFrame with at least:
                date, item_number, item_description, quantity, category
